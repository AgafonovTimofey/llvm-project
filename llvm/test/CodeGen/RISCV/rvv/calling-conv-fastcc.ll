...
; RV32-NEXT:    li a5, 5
; RV32-NEXT:    li a6, 6
; RV32-NEXT:    vs8r.v v8, (t5)
; RV32-NEXT:    vs8r.v v8, (t3)
; RV32-NEXT:    sw a7, 0(sp)
; RV32-NEXT:    add a7, t5, a0
; RV32-NEXT:    vs8r.v v8, (a7)
; RV32-NEXT:    li a7, 7
; RV32-NEXT:    add a0, t3, a0
; RV32-NEXT:    vs8r.v v8, (a0)
; RV32-NEXT:    li a0, 0
...
; RV64-NEXT:    add a7, t5, a0
; RV64-NEXT:    vs8r.v v8, (a7)
; RV64-NEXT:    li a7, 7
; RV64-NEXT:    add a0, t3, a0
; RV64-NEXT:    vs8r.v v8, (a0)
; RV64-NEXT:    li a0, 0
